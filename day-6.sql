...
---(Display product_name, a new column stock_status whose values are based on below condition units_in_stock = 0  
is 'Out of Stock'  units_in_stock < 20  is 'Low Stock'.
...
ALL(select category_id  from categories where category_name = 'Beverages');
...
select o.order_id, o.order_date,o.freight, o.employee_id 
from orders o
where o.employee_id = 
